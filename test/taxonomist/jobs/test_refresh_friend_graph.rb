...
require 'taxonomist/jobs/refresh_friend_graph'

class TestRefreshFriendGraph < TestJob
  def test_refresh_friend_graph
    ...
    Jobs::RefreshFriendGraph.enqueue(@user.id, friend_graph.keys)
